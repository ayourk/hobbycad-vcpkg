...
# Fix ARM64 Windows static linking: lib.exe defaults to x64 even on ARM64 hosts
set(ARM64_STATIC_LINKER_FLAGS "")
if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64" AND VCPKG_TARGET_IS_WINDOWS AND VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    set(ARM64_STATIC_LINKER_FLAGS "-DCMAKE_STATIC_LINKER_FLAGS=/MACHINE:ARM64")
endif()
